...
<Root LangModule="ailgcode" Version="1.0">
  ...
  <Preprocess>
    ...
    <PP_RULE_MODE_40000000 Search="TRF_MODE_IN_SW_ENDS" Replace="1037341824"/>
  ...
  <Types>
    ...
    <TangentialAxisOffset type="FLOAT" MinValue="0" MaxValue="360" />
    ...
    <RParamIndex type="INT" IsLiteral="Yes" MinValue="0" MaxValue="999" />
  ...
  <SysVars>
    ...
    <FILTER_ERR Name="$FILTER_ERR">
      <SET>
        ...
        #next_motion.Data.SystemVariable.SysVarIdx = 7;
    ...
    <FRAME_ANGLE_INPUT_MODE Name = "$FRAME_ANGLE_INPUT_MODE">
      ...
      <SET>
        ...
        #next_motion.Data.SystemVariable.SysVarIdx = 18;
        #next_motion.Data.SystemVariable.AxIdx = -1;
  ...
  <GCodes>
    ...
    <G04 GNum="4" Alias="$TIME" Group="38" AllowGroups="">
    ...
    <G16 GNum="16" Group="19" AllowGroups="6,8,19,21,101,102,103">
    ...
    <G53 GNum="53" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G54 GNum="54" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G55 GNum="55" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G56 GNum="56" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G57 GNum="57" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G58 GNum="58" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G59 GNum="59" Group="6" AllowGroups="8,19,21,101,102,103">
    ...
    <G92 GNum="92" Group="21" ResetArgs="Yes" AllowGroups="6,8,19,32,101,102,103">
    ...
    <G103 GNum="103" Group="23" AllowGroups="">
    ...
    <G104 GNum="104" Group="23" AllowGroups="">
    ...
    <G105 GNum="105" Group="24" AllowGroups="">
    ...
    <G106 GNum="106" Group="25" AllowGroups="">
    ...
    <G107 GNum="107" Group="26" AllowGroups="">
    ...
    <G113 GNum="113" Group="28" AllowGroups="">
    ...
    <G126_1 GNum="126.1" Alias="$VE" Group="11" DenyGroups="11" >
      <!--G127 $VE <value> [$LIN] : Rounding edges -->
    ...
    <G132 GNum="132" Group="4" AllowGroups="">
      <!--G132: CDC with linear transitions-->
      #next_motion.Command = MPCMD_CDC_TRANS_LINES;
      PushPacket(::);
      </G132>
    <G133 GNum="133" Group="4" Alias="$WRK_R_ON" AllowGroups="">
    ...
    <G141 GNum="141" Group="15">
      ...
      <Arg DataType="EqString" ref="eq" MinCount="0" MaxCount="1" />
      <Arg DataType="TangentialAxisOffset" ref="offset" />
    ...
    <G153 GNum="153" Group="29" RequireGroups="1000">
    ...
    <G170 GNum="170" Group="30" AllowGroups="40,41,42,43,44,101,102">
    ...
    <G192 GNum="192" Group="32" ResetArgs="Yes" AllowGroups="6,8,19,21,101,102,103">
    ...
    <G211 GNum="211" Group="27" AllowGroups="">
      <!--AllowGroups is empty meaning that no other commands are allowed on this line-->
    ...
    <G292 GNum="292" Group="32" ResetArgs="Yes" AllowGroups="6,8,19,21,101,102,103">
    ...
    <G320 GNum="320" Alias="WS_MAIN_DEF" Group="212" MinArgs="6" MaxArgs="6" >
    ...
    <G320.2 GNum="320.2" Alias="WS_CTRL_ON" Group="212" MinArgs="0" MaxArgs="0" >
    ...
    <G320.5 GNum="320.5" Alias="PROTBLOCK_DEF" Group="212" MinArgs="7" MaxArgs="7" >
    ...
    <!-- Tech-Params implemented as Alias'ed GCodes -
      ...
      -->
    <G501_FEED GNum="501" Alias="F:[\d\s=]|F:EX[FLWB]\d|F:[PR]\d" AliasIsPattern="Yes" Group="100">
    ...
    <G810 GNum="810" Alias="OPTI_SPEED_START" Group="200">
      <!--G810: Temporary for segmentation in path planner-->
      #next_motion.Command = MPCMD_SEGMENTATION_START;
      PushPacket(::);
      </G810>
    <G811 GNum="811" Alias="OPTI_SPEED_END" Group="200">
      <!--G811: Temporary for segmentation in path planner-->
